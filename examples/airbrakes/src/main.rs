...
use embassy_stm32::{bind_interrupts, dma::NoDma, gpio::{Level, Output, OutputType, Speed}, peripherals::{self, DMA1_CH0, DMA1_CH1, PD8, PD9, USART3}, time::khz, timer::{simple_pwm::{PwmPin, SimplePwm, SimplePwmChannel}, GeneralInstance4Channel}, usart::{self, Config, Uart}, Peripherals};
